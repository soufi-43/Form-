...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  el: '#app',
  router: new vue_router__WEBPACK_IMPORTED_MODULE_3__.default(_routes_index__WEBPACK_IMPORTED_MODULE_0__.default),
...
var mutations = (_mutations = {}, _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__.SAVE_TOKEN, function (state, _ref) {
  ...
  state.token = token, js_cookie__WEBPACK_IMPORTED_MODULE_2___default().set('token', token, {
    expires: remember ? 365 : null
  });
}), _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__.LOGIN_SUCCESS, function (state, _ref2) {
  var token = _ref2.token,
      rembmer = _ref2.rembmer;
  state.loading = false;
  state.auth_err = null;
  state.token = token;
  state.isLogged = true;
...
}), _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__.LOGIN_FAILED, function (state, _ref3) {
  var error = _ref3.error;
  state.loading = false;
  state.auth_err = error;
  state.isLogged = false;
}), _defineProperty(_mutations, _mutations_types__WEBPACK_IMPORTED_MODULE_3__.FETCH_USER_SUCCESS, function (state, _ref4) {
  var user = _ref4.user;
